...
const InfoRow = ({ labelEn, labelJa, children }) => (
  <div className="border-t border-emerald-100 first:border-t-0 py-3 md:py-4">
    <div className="grid md:grid-cols-[220px,1fr] gap-2 md:gap-4">
      <div className="text-xs font-semibold tracking-wide text-emerald-700 uppercase">
        <div>{labelEn}</div>
        <div className="mt-0.5 text-[11px] normal-case text-emerald-500">
          {labelJa}
        </div>
      </div>
...
const BusinessInfo = () => {
  return (
    <div className="min-h-screen bg-emerald-50 text-emerald-950 flex items-start justify-center px-4 py-10 md:py-14">
      <article className="w-full max-w-3xl bg-white border border-emerald-100 rounded-3xl shadow-sm p-6 md:p-8">
        {/* Title / Intro */}
        ...
        <section aria-label="Business information">
          ...
          <InfoRow labelEn="Website" labelJa="ウェブサイト">
            <a
              ...
              className="text-emerald-800 underline break-all hover:text-emerald-600"
            >
              https://halallens.org
            </a>
          </InfoRow>
          ...
          <InfoRow labelEn="Service Provided" labelJa="提供するサービスの内容">
            ...
            <ul className="mt-1 list-disc list-inside space-y-1 text-emerald-800">
          ...
          <InfoRow labelEn="Price" labelJa="販売価格">
            ...
            <ul className="mt-2 list-disc list-inside text-emerald-800 text-sm">
