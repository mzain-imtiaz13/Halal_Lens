      ...
      <div className="mx-auto max-w-6xl px-4 py-12 md:py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((f) => (
            <div
              key={f.title}
              className="group rounded-2xl border border-emerald-100 bg-white p-5 shadow-sm hover:-translate-y-1 hover:shadow-md hover:bg-emerald-50 transition duration-300"
            >
              <div className="mb-3 inline-flex h-9 w-9 items-center justify-center rounded-xl bg-emerald-100 text-xl">
                {f.icon}
              </div>
