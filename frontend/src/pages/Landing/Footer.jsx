...
const Footer = () => {
  return (
    <footer
      id="footer"
      className="bg-brand-900 text-brand-50 mt-8 md:mt-12"
    >
      <div className="mx-auto max-w-6xl px-4 py-10 md:py-12 grid md:grid-cols-4 gap-8 text-sm">
        <div className="md:col-span-2 space-y-3">
          <div className="flex items-center gap-2">
            <div className="flex h-8 w-8 items-center justify-center rounded-full bg-brand-50 text-brand-900 text-xs font-bold">
              حلال
            </div>
        ...
        <div>
          <h4 className="text-xs font-semibold uppercase tracking-wide text-brand-100 mb-2">
            Product
          </h4>
          <ul className="space-y-1 text-xs text-brand-100/80">
            <li>
        ...
        <div>
          ...
          <ul>
            <li>
              <Link to="/support" className="text-xs text-brand-100/80">
                Contact & Support
              </Link>
            </li>
            <li>
              <Link to="/about" className="text-xs text-brand-100/80">
                About
              </Link>
            </li>
          </ul>
      ...
      <div className="border-t border-brand-800">
        <div className="mx-auto max-w-6xl px-4 py-3 flex flex-col md:flex-row items-center justify-between gap-2">
          ...
          <div className="flex gap-3 text-[11px] text-brand-200">
