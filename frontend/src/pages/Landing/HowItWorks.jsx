const HowItWorks = () => {
  ...
  return (
    <section id="workflow" className="bg-white border-t border-green-100">
      <div className="mx-auto max-w-6xl px-4 py-12 md:py-16">
        <div className="grid md:grid-cols-2 gap-10 items-start">
            ...
            <div className="mt-6 space-y-4">
              {workflowSteps.map((step, index) => (
                <div key={step.title} className="flex gap-3 items-start">
                  <div className="mt-1 flex h-7 w-7 items-center justify-center rounded-full bg-green-100 text-[11px] font-semibold text-green-700 border border-green-200">
                    {index + 1}
                  </div>
                  <div>
          ...
          <div className="rounded-3xl bg-green-50 border border-green-100 p-5 shadow-sm">
            <h3 className="text-sm font-semibold text-green-900 mb-3">
              Tech stack overview
            </h3>
            <div className="grid grid-cols-2 gap-4 text-xs text-green-800">
              <div className="space-y-2">
                <p className="font-semibold text-green-900">Frontend</p>
              ...
              <div className="space-y-2">
                <p className="font-semibold text-green-900">Infrastructure</p>
                <ul className="space-y-1 list-disc list-inside">
              ...
              <div className="space-y-2">
                <p className="font-semibold text-green-900">Admin Tools</p>
                <ul className="space-y-1 list-disc list-inside">
