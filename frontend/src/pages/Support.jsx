const Support = () => {
  return (
    <div className="min-h-screen bg-brand-50 text-brand-950 flex items-start justify-center px-4 py-10 md:py-14">
      <div className="w-full max-w-3xl bg-white border border-brand-100 rounded-3xl shadow-sm p-6 md:p-8">
        {/* Title */}
        <section className="mb-6 md:mb-8 border-b border-brand-100 pb-4">
        ...
        <div className="space-y-6 md:space-y-8 text-sm text-brand-900 leading-relaxed">
          {/* Contact Us */}
          <section>
            <h2 className="font-semibold text-brand-950 mb-2">Contact Us</h2>
          ...
          {/* About Halal Lens */}
          <section>
            <h2 className="font-semibold text-brand-950 mb-2">
              About Halal Lens
            </h2>
            <p className="text-brand-800 mb-2">
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-3 text-brand-800">
              <li>
          ...
          {/* Disclaimer */}
          <section>
            <h2 className="font-semibold text-brand-950 mb-2">Disclaimer</h2>
