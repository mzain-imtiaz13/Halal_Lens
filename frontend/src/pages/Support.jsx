const Support = () => {
  return (
    <div className="min-h-screen bg-emerald-50 text-emerald-950 flex items-start justify-center px-4 py-10 md:py-14">
      <div className="w-full max-w-3xl bg-white border border-emerald-100 rounded-3xl shadow-sm p-6 md:p-8">
        {/* Title */}
        <section className="mb-6 md:mb-8 border-b border-emerald-100 pb-4">
        ...
        <div className="space-y-6 md:space-y-8 text-sm text-emerald-900 leading-relaxed">
          {/* Contact Us */}
          <section>
            <h2 className="font-semibold text-emerald-950 mb-2">Contact Us</h2>
          ...
          <section>
            ...
            <ol className="list-decimal list-inside space-y-3 text-emerald-800">
              <li>
          ...
          {/* Disclaimer */}
          <section>
            <h2 className="font-semibold text-emerald-950 mb-2">Disclaimer</h2>
