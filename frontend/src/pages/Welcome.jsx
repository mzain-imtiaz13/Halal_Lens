...
export default function Welcome() {
  ...
  return (
    <div className="space-y-6">
      {/* Header / Greeting */}
      <section className="rounded-2xl border border-emerald-100 bg-linear-to-r from-emerald-50 via-white to-emerald-50 p-6 shadow-sm">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <div className="mt-2 flex flex-col items-start gap-2 rounded-xl border border-emerald-100 bg-white px-4 py-3 text-xs text-slate-700 shadow-sm md:mt-0">
