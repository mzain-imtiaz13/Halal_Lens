const TermsOfService = () => {
  return (
    <div className="min-h-screen bg-brand-50 text-brand-950 flex flex-col">

      {/* Main content */}
      <main className="flex-1">
        <div className="max-w-3xl mx-auto px-4 py-10 md:py-14">
          <div className="bg-white border border-brand-100 rounded-3xl shadow-sm p-6 md:p-8">
            {/* Title */}
            ...
            <div className="space-y-6 md:space-y-8 text-sm text-brand-900 leading-relaxed">
              ...
              <section id="halal-disclaimer">
                ...
                <p className="mb-1 text-brand-800">You understand that:</p>
                <ul className="list-disc list-inside space-y-1 text-brand-800">
              ...
              <section id="contact">
                ...
                <p className="mt-2 text-brand-900 font-semibold">
