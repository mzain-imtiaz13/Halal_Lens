    ...
    <div className="min-h-screen text-green-950 flex flex-col">
      ...
      <header className="pt-4">
        <div className="max-w-4xl mx-auto p-4">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-green-950 mb-3">
            Data Deletion Request
          </h1>
          <p className="text-sm md:text-base text-green-800 max-w-2xl">
      ...
      <main className="flex-1">
        <div className="max-w-4xl mx-auto p-4">
          <section className="bg-white border border-green-100 rounded-3xl shadow-sm p-6 md:p-8 space-y-6 md:space-y-8">
            <div className="space-y-3 text-sm text-green-900 leading-relaxed">
              ...
              <div>
                <h2 className="text-sm md:text-base font-semibold text-green-950 mb-2">
            ...
            {/* Form */}
            <div className="border-t border-green-100 pt-6 md:pt-8">
              <h2 className="text-base md:text-lg font-semibold text-green-950 mb-2">
              ...
              {!isAuthenticated && (
                <p className="mb-4 text-xs text-green-800 bg-green-50 border border-green-200 rounded-lg px-3 py-2">
              ...
              >
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full rounded-lg border px-3 py-2 text-sm text-green-900 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 ${
                      emailDisabled
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={`w-full rounded-lg border border-green-200 px-3 py-2 text-sm text-green-900 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 resize-none ${
                      formDisabled
                ...
                {/* Confirmation */}
                <div className="border border-green-100 rounded-xl bg-green-50/60 px-3 py-3">
                  <label className="flex items-start gap-2 text-xs text-green-900">
                    <input
                      ...
                      onChange={handleChange}
                      disabled={formDisabled}
                      className="mt-0.5 h-4 w-4 rounded border-green-300 text-green-600 focus:ring-green-500 disabled:cursor-not-allowed"
                      required
                    />
                    <span>
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="inline-flex items-center justify-center rounded-lg bg-green-700 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-800 disabled:opacity-60 disabled:cursor-not-allowed"
                  >
                    {formDisabled
                      ? "Sign in to submit"
                      : submitting
