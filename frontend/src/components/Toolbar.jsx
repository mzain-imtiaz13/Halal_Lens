          ...
          {onReset && (
            <div>
              <button
                type="button"
                onClick={onReset}
                className="cursor-pointer rounded-md border border-slate-200 bg-white px-4 py-3 text-xs font-medium text-slate-600 shadow-sm hover:bg-slate-50 hover:text-slate-800 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-1"
              >
                Reset
              </button>
            </div>
